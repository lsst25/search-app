...
import {NewsSearchResponse, SearchModeParam, SearchParamsObject, SearchResponse} from "./search.interface";
...
export class SearchHttpService {
    ...
    public search(
        searchValue: string,
        itemsOffset: number,
        itemsNumber: number): Observable<SearchResponse> {
    ...
    public searchNews(
        searchValue: string,
        itemsOffset: number,
        itemsNumber: number): Observable<NewsSearchResponse> {
